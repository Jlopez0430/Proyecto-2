...
class CalendarioServiceTest {
    ...
    // Test 9: Eliminar un calendario exitosamente
    @Test
    void testDeleteCalendario_ShouldDeleteCalendarioSuccessfully() throws Exception {
        Calendario calendario = new Calendario();
        calendario.setId(1L);
        ...
        verify(calendarioRepository, times(1)).delete(calendario);
    }
