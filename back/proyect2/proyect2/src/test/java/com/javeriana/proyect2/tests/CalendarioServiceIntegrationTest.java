...
class CalendarioServiceIntegrationTest {
    ...
    @Test
    void testCreateCalendario_ShouldCreateCalendarioWhenUserIsLoggedIn() throws Exception {
    ...
    @Test
    void testCreateCalendario_ShouldThrowExceptionWhenUserIsNotLoggedIn() {
